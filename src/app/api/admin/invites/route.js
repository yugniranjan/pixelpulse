...
function buildConfirmationEmailText(invite = {}) {
  ...
  return [
    ...
    `Party End Time: ${invite.partyEndTime || "As confirmed"}`,
...
export async function POST(req) {
  ...
  const invite = {
    ...
    date,
    timeLabel: cleanText(body.timeLabel) || "Party Start Time",
    time,
    partyEndTime: cleanText(body.partyEndTime),
...
export async function PUT(req) {
  ...
  const invite = {
    ...
    timeLabel: existing.timeLabel || "Party Start Time",
    time: cleanText(body.time) || existing.time || "",
    partyEndTime: cleanText(body.partyEndTime) || existing.partyEndTime || "",
