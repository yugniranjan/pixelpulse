...
export async function PUT(req) {
  ...
  const invite = {
    ...
    foodAddOns: bodyText("foodAddOns", existing.foodAddOns || ""),
    additionalExtras: bodyText("additionalExtras", existing.additionalExtras || ""),
    ...
    address: bodyText("address", existing.address || DEFAULT_ADDRESS) || DEFAULT_ADDRESS,
    waiverLabel: existing.waiverLabel || "Waiver",
    waiverText: bodyText("waiverText", existing.waiverText || ""),
    waiverButton: bodyText("waiverButton", existing.waiverButton || "Complete waiver") || "Complete waiver",
    waiverLink,
    rsvpLabel: existing.rsvpLabel || "RSVP",
    rsvpName: bodyText("rsvpName", existing.rsvpName || ""),
    rsvpText: bodyText("rsvpText", existing.rsvpText || ""),
    phone: bodyText("phone", existing.phone || ""),
    businessPhoneLabel: existing.businessPhoneLabel || "Pixel Pulse Phone",
    businessPhone: bodyText("businessPhone", existing.businessPhone || ""),
    directionsLabel: existing.directionsLabel || "Directions",
    directionsText: existing.directionsText || "Open map",
    directionsLink: bodyText("directionsLink", existing.directionsLink || DEFAULT_DIRECTIONS_LINK) || DEFAULT_DIRECTIONS_LINK,
    contactLinksLabel: existing.contactLinksLabel || "Pixel Pulse contact links",
    footer: bodyText("footer", existing.footer || ""),
