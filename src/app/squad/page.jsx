...
function getSquadContent(rows = []) {
  ...
  return {
    ...
    referral: {
      ...
      description: getConfiguredValue(rows, ["squadReferralDescription", "referralDescription"], "Email your friends a unique 10% discount code made from your initials."),
      ...
      submitText: getConfiguredValue(rows, ["squadReferralSubmitText", "referralSubmitText"], "Send 10% Referral"),
      helperText: getConfiguredValue(rows, ["squadReferralHelperText", "referralHelperText"], "Friends receive a unique 10% discount code."),
      sendingText: getConfiguredValue(rows, ["squadReferralSendingText", "referralSendingText"], "Sending referral..."),
      successText: getConfiguredValue(rows, ["squadReferralSuccessText", "referralSuccessText"], "Referral sent. Your friends now have a unique 10% code."),
